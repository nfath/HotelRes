...
pub mod my_psp34 {
	...
	impl PSP34 for HotelRes {}
	impl Ownable for HotelRes {}
	impl PSP34Burnable for HotelRes {
		#[ink(message)]
	...
	impl PSP34Mintable for HotelRes {
		#[ink(message)]
		#[openbrush::modifiers(only_owner)]
		fn mint(
            &mut self,
	...
	impl PSP34Enumerable for HotelRes {}
	impl PSP34Metadata for HotelRes {}
